...
const unsigned char KX022_CNTL1_CFGDAT		= 0x10u;
// Set Output Data Rate(ODR) to 50Hz
const unsigned char KX022_ODCNTL_CFGDAT		= 0x02u;
// Set Tilt Output Data Rate to 50Hz
const unsigned char KX022_CNTL3_CFGDAT		= 0x00u;
// Set Tilt Timer to 20ms
const unsigned char KX022_TILT_TIMER_CFGDAT	= 0x01u;
const unsigned char KX022_INC1_CFGDAT 		= 0x28u;
const unsigned char KX022_INC2_CFGDAT		= 0x02u;
const unsigned char KX022_INC4_CFGDAT		= 0x02u;
const unsigned char KX022_WUFC_CFGDAT		= 0x0Au;
const unsigned char KX022_ATH_CFGDAT		= 0x01u;
...
void Init_KX022()
{
	...
	I2C_Write(KX022_I2C_ADDR, &KX022_INC1, 1, &KX022_INC1_CFGDAT, 1);
	I2C_Write(KX022_I2C_ADDR, &KX022_INC2, 1, &KX022_INC2_CFGDAT, 1);
	I2C_Write(KX022_I2C_ADDR, &KX022_INC4, 1, &KX022_INC4_CFGDAT, 1);
	I2C_Write(KX022_I2C_ADDR, &KX022_WUFC, 1, &KX022_WUFC_CFGDAT, 1);
	I2C_Write(KX022_I2C_ADDR, &KX022_ATH, 1, &KX022_ATH_CFGDAT, 1);
	...
	//INT_REL needs to be read to clear the existing register
